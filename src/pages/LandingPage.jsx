  ...
  const features = [
    {
      ...
      description: "Rent tractors, JCBs, and other agricultural equipment with smart booking system.",
      benefits: ["Hourly/Daily rates", "Real-time tracking", "Insurance included"],
    },
    {
      icon: <Wrench size={28} />,
      title: "Quality Tools",
  ...
  const howItWorksSteps = [
    {
      ...
      description: "Create your account and add farm details for personalized recommendations.",
      time: "2 minutes"
    },
    {
      step: "02",
      title: "Browse & Get AI Suggestions",
      description: "Explore equipment and get AI-powered recommendations based on your needs.",
      time: "Browse anytime"
    },
    {
      step: "03",
      title: "Book & Connect Safely",
      description: "Book equipment with secure payment and connect with verified owners.",
      time: "Instant booking"
    },
    {
      step: "04",
      title: "Farm Smarter",
      description: "Use rented equipment efficiently with GPS tracking and support.",
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            🚀 India's Leading Agricultural Platform
          </div>
          ...
          >
            Connect with equipment owners, get AI-powered farming recommendations, 
            and access premium supplies - all in one revolutionary platform.
          </p>
            ...
            {stats.map((stat, index) => (
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = '0 8px 25px rgba(5, 150, 105, 0.15)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'translateY(0)';
                  e.currentTarget.style.boxShadow = '0 2px 10px rgba(5, 150, 105, 0.05)';
                }}
              >
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
            ...
            <p style={{
              ...
              Complete farming solutions powered by AI technology and community support.
            </p>
          </div>
          ...
          <div style={{
            ...
            {features.map(({ icon, title, description, benefits }, i) => (
              <div
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'translateY(0)';
                  e.currentTarget.style.boxShadow = '0 4px 20px rgba(5, 150, 105, 0.08)';
          ...
          <div style={{
            ...
            {[
              ...
              <div
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = 'translateY(-8px)';
                  e.currentTarget.style.boxShadow = '0 15px 40px rgba(5, 150, 105, 0.15)';
                  e.currentTarget.style.borderColor = '#059669';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'translateY(0)';
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          ...
          <p style={{
            ...
            Join thousands of farmers using smart technology for better yields and sustainable practices.
          </p>
